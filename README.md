...
- **Onboarding step 3:** **Razorpay** checkout UI — bypassed until API keys are set (`RAZORPAY_BYPASS=true` or missing keys); then real payments with `RAZORPAY_BYPASS=false`
